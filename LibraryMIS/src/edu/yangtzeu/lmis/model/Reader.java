...
public  class Reader extends AbstractModel{
	...
	public Reader(Reader rt) {
		setRdID(rt.getRdID());
		setRdName(rt.getRdName());
		setRdSex(rt.getRdSex());
		setRdType(rt.getRdType());
		setRdDept(rt.getRdDept());
		setRdPhone(rt.getRdPhone());
		setRdEmail(rt.getRdEmail());
		setRdDateReg(rt.getRdDateReg());
		setRdPhoto(rt.getRdPhoto());
		setRdStatus(rt.getRdStatus());
		setRdBorrowQty(rt.getRdBorrowQty());
		setRdPwd(rt.getRdPwd());
		setRdAdminRoles(rt.getRdAdminRoles());
	}
